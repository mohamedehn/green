...
export default function DisplayWorks({title, backgroundImg, url}) {
    ...
    return (
        <div className="relative flex items-center justify-center h-[335px] w-full shadow-xl shadow-gray-400 rounded-xl p-4 group hover:bg-gradient-to-r from-[#568d51] to-[#92f19a]">
