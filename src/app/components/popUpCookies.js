...
//Si oui, nous affichons le message et les boutons Accepter/Refuser.
  return visible ? (
    <div className="fixed bottom-0 right-0 left-0 z-50 p-4 text-gray-200 bg-white rounded-3xl w-[70%] sm:w-[60%] m-auto">
      <p className="text-gray-600 mt-3 text-base sm:mx-auto sm:mt-5 sm:text-lg md:mt-5 md:text-xl lg:mx-0 text-justify">
        ...
        d&apos;informations, consultez nos <Link href="/mentions" className="no-underline text-green-800 font-bold">mentions légales</Link>.
      </p>
      <div className="flex justify-end pt-2">
        <button
          className="px-4 py-2 mr-2 text-sm font-bold text-white bg-green-700 rounded"
          onClick={() => {
